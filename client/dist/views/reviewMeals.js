var ReviewMeals = React.createClass({displayName: "ReviewMeals",
      ...
      return (
        React.createElement("div", null, 
          this.props.recipes.map(function(item, i) {
            return [
              React.createElement("button", {"data-id": i, onClick: this.rejectRecipe}, "X"),
              React.createElement("div", {key: i}, item.get('recipeName'))
              ];
          }, this), 
          React.createElement("button", {onClick: this.handleSubmit}, "Save meal plan")
        )
      );
    }
});
